		...
		for(let i=0; i<rows.length; i++){
			...
			<tr>
				...
				<td>
                    ...
                    <button class="btn btn-info btn-xs class-edit" data-value="${row["department"]["num"]}"><i class="glyphicon glyphicon-pencil"></i> edit </button> 
                </td>
                <td>
                ...
                <td>
					<span>${row["room"] != null ? row["room"]["name"] : "无"}</span>
                    <button class="btn btn-info btn-xs room-edit"data-value="${row["gender"]}"><i class="glyphicon glyphicon-pencil"></i> edit </button>
                </td>
                <td>
